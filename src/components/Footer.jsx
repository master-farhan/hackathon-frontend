...
const Footer = () => {
  return (
    <footer className="bg-primary text-white p-5 md:px-[4vw] lg:py-[4vh]">
      <div className="flex flex-col md:flex-row justify-between gap-10 lg:gap-[3vw]:">
        ...
        <div className="flex flex-col gap-4 lg:gap-[1.5vw]">
          ...
          <p className="text-sm lg:text-[1vw] mx-w-[30vw]">
            Making ice creams since 1944. A blend of joy, flavor, and quality.
          </p>
          <div className="flex gap-4 lg:mb-[1.4vw] mt-2 lg:mt-[.7vw]">
            <a
        ...
        {/* Links */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 lg:gap-[2vw] lg:text-[1vw] text-sm">
          <div>
            <h4 className="font-semibold mb-3 lg:mb-[1vw]">About</h4>
          ...
          <div>
            <h4 className="font-semibold mb-3 lg:mb-[1vw]">Products</h4>
            <ul className="space-y-2 lg:space-y-[.8vw]">
              <li>
          ...
          <div>
            <h4 className="font-semibold mb-3 lg:mb-[1vw]">Legal</h4>
            <ul className="space-y-2 lg:space-y-[.8vw]">
              <li>
      ...
      {/* Bottom */}
      <div className="border-t border-milk mt-10 lg:mt-[3vw] lg:pt-[2vw] pt-6 text-sm lg:text-[1vw] text-milk/50 text-center">
